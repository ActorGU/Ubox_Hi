...
{
    "/sharefs/res/apple.bits",
    "/sharefs/res/applets.bits",
    "/sharefs/res/calendar.bits",
    "/sharefs/res/foot.bits",
    "/sharefs/res/gmush.bits",
    "/sharefs/res/gimp.bits",
    "/sharefs/res/gsame.bits",
    "/sharefs/res/keys.bits"
};
#define BACKGROUND_NAME  "/sharefs/res/background.bits"
#else
static const HI_CHAR *pszImageNames[] =
{
    "res/apple.bits",
