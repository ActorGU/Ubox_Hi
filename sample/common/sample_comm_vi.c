...
combo_dev_attr_t LVDS_4lane_CHN0_SENSOR_IMX250_12BIT_5M_NOWDR_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_LVDS,
    .data_rate = MIPI_DATA_RATE_X1,
    .img_rect = {0, 0, 2048, 1936},

    {
        .lvds_attr =
        {
            ...
            .fid_attr = {LVDS_FID_NONE, 0},
            .data_endian = LVDS_ENDIAN_BIG,
            .sync_code_endian = LVDS_ENDIAN_BIG,
            .lane_id = {0, 1, 2, 3},
            .sync_code = {{{0xAB0,0xB60,0x800,0x9D0},{0xAB0,0xB60,0x800,0x9D0},{0xAB0,0xB60,0x800,0x9D0},{0xAB0,0xB60,0x800,0x9D0}},
...
combo_dev_attr_t LVDS_2LANE_8BIT_LGC6122_NOWDR_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_LVDS,
    .data_rate  = MIPI_DATA_RATE_X1,
...
combo_dev_attr_t LVDS_2LANE_8BIT_CML1024_NOWDR_ATTR =
{
    .devno = 1,
    .input_mode = INPUT_MODE_LVDS,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 1024, 1024},
    {
    .lvds_attr =
    {
        .input_data_type   = DATA_TYPE_RAW_8BIT,
...
combo_dev_attr_t LVDS_4LANE_8BIT_CML2048_NOWDR_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_LVDS,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 2048, 2048},
    {
    .lvds_attr =
    {
        .input_data_type   = DATA_TYPE_RAW_8BIT,
...
VI_DEV_ATTR_S DEV_ATTR_IMX250_5M_BASE =
{
    VI_MODE_LVDS,
    VI_WORK_MODE_1Multiplex,
    {0xFFF00000,    0x0},
...
VI_DEV_ATTR_S DEV_ATTR_LVDS_2LANE_8BIT_LGC6122_BASE =
{
    VI_MODE_LVDS,
    VI_WORK_MODE_1Multiplex,
    {0xFF000000,    0x0},
...
VI_DEV_ATTR_S DEV_ATTR_LVDS_2LANE_8BIT_CML1024_BASE =
{
    VI_MODE_LVDS,
    VI_WORK_MODE_1Multiplex,
    {0xFF000000,    0x0},
...
VI_DEV_ATTR_S DEV_ATTR_LVDS_4LANE_8BIT_CML2048_BASE =
{
    VI_MODE_LVDS,
    VI_WORK_MODE_1Multiplex,
    {0xFF000000,    0x0},
...
VI_PIPE_ATTR_S PIPE_ATTR_LVDS_2LANE_RAW8_LGC6122 =
{
    VI_PIPE_BYPASS_NONE, HI_FALSE,HI_FALSE,
    640, 512,
...
VI_PIPE_ATTR_S PIPE_ATTR_LVDS_2LANE_RAW8_CML1024 =
{
    VI_PIPE_BYPASS_NONE, HI_FALSE,HI_FALSE,
    1024, 1024,
    PIXEL_FORMAT_RGB_BAYER_8BPP,
...
VI_PIPE_ATTR_S PIPE_ATTR_LVDS_4LANE_RAW8_CML2048 =
{
    VI_PIPE_BYPASS_NONE, HI_FALSE,HI_FALSE,
    2048, 2048,
    PIXEL_FORMAT_RGB_BAYER_8BPP,
...
static VI_PIPE_ATTR_S PIPE_ATTR_2048x1936_RAW12_420_3DNR_RFR =
{
    VI_PIPE_BYPASS_NONE, HI_FALSE, HI_FALSE,
    2048, 1936,
    PIXEL_FORMAT_RGB_BAYER_12BPP,
...
VI_CHN_ATTR_S CHN_ATTR_LVDS_2LANE_RAW8_LGC6122 =
{
    {640, 512},
    PIXEL_FORMAT_YVU_SEMIPLANAR_420,
    DYNAMIC_RANGE_SDR8,
...
VI_CHN_ATTR_S CHN_ATTR_LVDS_2LANE_RAW8_CML1024 =
{
    {1024, 1024},
    PIXEL_FORMAT_YVU_SEMIPLANAR_420,
    DYNAMIC_RANGE_SDR8,
...
VI_CHN_ATTR_S CHN_ATTR_LVDS_4LANE_RAW8_CML2048 =
{
    {2048, 2048},
    PIXEL_FORMAT_YVU_SEMIPLANAR_420,
    DYNAMIC_RANGE_SDR8,
 ...
 VI_CHN_ATTR_S CHN_ATTR_2048x1936_420_SDR8_LINEAR =
{
    {2048, 1936},
    PIXEL_FORMAT_YVU_SEMIPLANAR_420,
    DYNAMIC_RANGE_SDR8,
...
HI_S32 SAMPLE_COMM_VI_GetComboAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, combo_dev_t MipiDev, combo_dev_attr_t* pstComboAttr)
{
    switch (enSnsType)
    {
        case SONY_IMX327_MIPI_2M_30FPS_12BIT:
            ...
            memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &LVDS_2LANE_8BIT_CML1024_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;
        ...
        case SONY_IMX307_MIPI_2M_30FPS_12BIT:
            ...
            memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &LVDS_2LANE_8BIT_LGC6122_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;
        ...
        case SONY_IMX335_MIPI_5M_30FPS_12BIT:
            ...
            memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &LVDS_4LANE_8BIT_CML2048_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;
        ...
        case SONY_IMX250_LVDS_5M_25FPS_12BIT:
            memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &LVDS_4lane_CHN0_SENSOR_IMX250_12BIT_5M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;
...
HI_U32 SAMPLE_COMM_VI_GetMipiLaneDivideMode(SAMPLE_VI_CONFIG_S* pstViConfig)
{
    ...
    if ((SONY_IMX327_2L_MIPI_2M_30FPS_12BIT == pstViConfig->astViInfo[0].stSnsInfo.enSnsType)
        || (SONY_IMX307_MIPI_2M_30FPS_12BIT == pstViConfig->astViInfo[0].stSnsInfo.enSnsType))
    {
...
HI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S* pstViDevAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX327_2L_MIPI_2M_30FPS_12BIT_WDR2TO1:
            ...
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_LVDS_2LANE_8BIT_CML1024_BASE, sizeof(VI_DEV_ATTR_S));
            break;
        ...
        case SONY_IMX307_2L_MIPI_2M_30FPS_12BIT:
            ...
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_LVDS_2LANE_8BIT_LGC6122_BASE, sizeof(VI_DEV_ATTR_S));
            break;
        ...
        case SONY_IMX335_MIPI_5M_30FPS_12BIT:
            ...
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_LVDS_4LANE_8BIT_CML2048_BASE, sizeof(VI_DEV_ATTR_S));
            break;
        ...
        case SONY_IMX250_LVDS_5M_25FPS_12BIT:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_IMX250_5M_BASE, sizeof(VI_DEV_ATTR_S));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetPipeAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_PIPE_ATTR_S* pstPipeAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX327_2L_MIPI_2M_30FPS_12BIT_WDR2TO1:
            ...
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_LVDS_2LANE_RAW8_CML1024, sizeof(VI_PIPE_ATTR_S));
            break;
        ...
        case SONY_IMX307_2L_MIPI_2M_30FPS_12BIT:
            // memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_1920x1080_RAW12_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_LVDS_2LANE_RAW8_LGC6122, sizeof(VI_PIPE_ATTR_S));
            break;
        ...
        case SONY_IMX335_MIPI_5M_30FPS_12BIT:
            ...
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_LVDS_4LANE_RAW8_CML2048, sizeof(VI_PIPE_ATTR_S));
            break;
        ...
        case SONY_IMX250_LVDS_5M_25FPS_12BIT:
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_2048x1936_RAW12_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            printf("PIPE_ATTR_2048x1936_RAW12_420_3DNR_RFR\r\n");
            break;
...
HI_S32 SAMPLE_COMM_VI_GetChnAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_CHN_ATTR_S* pstChnAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX327_2L_MIPI_2M_30FPS_12BIT_WDR2TO1:
            ...
            memcpy_s(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_LVDS_2LANE_RAW8_CML1024, sizeof(VI_CHN_ATTR_S));
            break;
        ...
        case SONY_IMX307_2L_MIPI_2M_30FPS_12BIT_WDR2TO1:
            // memcpy_s(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_1920x1080_420_SDR8_LINEAR, sizeof(VI_CHN_ATTR_S));
            memcpy_s(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_LVDS_2LANE_RAW8_LGC6122, sizeof(VI_CHN_ATTR_S));
            break;
        ...
        case SONY_IMX335_MIPI_5M_30FPS_10BIT_WDR2TO1:
            ...
            memcpy_s(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_LVDS_4LANE_RAW8_CML2048, sizeof(VI_CHN_ATTR_S));
            break;
        ...
        case SONY_IMX250_LVDS_5M_25FPS_12BIT:
            memcpy_s(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_2048x1936_420_SDR8_LINEAR, sizeof(VI_CHN_ATTR_S));
            break;
