...
HI_S32 SAMPLE_VENC_MJPEG_JPEG(void)
{
    ...
    HI_S32 s32Ret;
    SIZE_S          stSize[2];
    PIC_SIZE_E      enSize[2]     = {PIC_2048x1936,PIC_720P};
    HI_S32          s32ChnNum     = 2;
    VENC_CHN        VencChn[2]    = {0,1};
    HI_U32          u32Profile[2] = {0,0};
   ...
   /***encode Mjpege **/
    ...
    // }
    stSize[1].u32Height = 600;
    stSize[1].u32Width = 600;
    ...
    s32Ret = HI_MPI_VENC_GetJpegParam(VencChn[1],&jpegParam);
    jpegParam.u32Qfactor = 20;
    s32Ret = HI_MPI_VENC_SetJpegParam(VencChn[1],&jpegParam);
    s32Ret = SAMPLE_COMM_VPSS_Bind_VENC(VpssGrp, VpssChn[1],VencChn[1]);
    if (HI_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("Venc bind Vpss failed for %#x!\n", s32Ret);
